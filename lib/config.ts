...
const config = {
  ...
  about: {
    image: '/profile.jpg',
    description: `I&apos;m a 16year old frontend developer based in  and currently working @supabase as a. I have a strong passion for UI/UX design and coding/building things that impact people&apos;s day to day lives and make them better. I am interested in Typescript, Next.js, Deno, Golang, and building consumer apps and developer tools. In my free time, you can see me skating, gaming, exploring, and talking to new people.`,
    cta: [
      {
        text: 'Resume',
        url: '/resume.pdf',
