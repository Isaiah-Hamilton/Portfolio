...
export const Projects = [
  {
    title: 'Live ATC',
    description:
      'Live ATC is a web app that allows users to listen to live air traffic control communications from around the world.',
    image: '/liveatc.png',
    tags: ['Data Scraping', 'UI Design', 'Prototyping'],
    bgColor: '#050505',
    textColor: '#ffffff',
  },
]
...
export const Skills = [
  {
    ...
    description:
      'Innovative problem-solving and impactful solutions for bringing new ideas to a cleaner codebase.',
  ...
  },
  {
    skill: 'Security',
    description:
      'Keeping user and company data safe by utilizing security measures at every stage of development.',
    icon: 'M16.5 10.5V6.75a4.5 4.5 0 1 0-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 0 0 2.25-2.25v-6.75a2.25 2.25 0 0 0-2.25-2.25H6.75a2.25 2.25 0 0 0-2.25 2.25v6.75a2.25 2.25 0 0 0 2.25 2.25Z',
  },
  {
    skill: 'API Design',
    description:
      'Leveraging valuable data insights to make informed design decisions for a better developer experience.',
  ...
  },
  {
    ...
    description:
      'Optimizing system resources for lightning-fast data delivery without compromise to the user.',
